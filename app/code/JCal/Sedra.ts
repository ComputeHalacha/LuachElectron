...
Sedra.sedraList = [
  { eng: 'Bereshis', heb: 'בראשית' },
  { eng: 'Noach', heb: 'נח' },
  { eng: 'Lech-Lecha', heb: 'לך לך' },
  { eng: 'Vayera', heb: 'וירא' },
  { eng: 'Chayei Sara', heb: 'חיי שרה' },
  { eng: 'Toldos', heb: 'תולדות' },
  { eng: 'Vayetzei', heb: 'ויצא' },
  { eng: 'Vayishlach', heb: 'וישלח' },
  { eng: 'Vayeishev', heb: 'וישב' },
  { eng: 'Mikeitz', heb: 'מקץ' },
  { eng: 'Vayigash', heb: 'ויגש' },
  { eng: 'Vayechi', heb: 'ויחי' },
  { eng: 'Shemos', heb: 'שמות' },
  { eng: "Va'era", heb: 'וארא' },
  { eng: 'Bo', heb: 'בא' },
  { eng: 'Beshalach', heb: 'בשלח' },
  { eng: 'Yisro', heb: 'יתרו' },
  { eng: 'Mishpatim', heb: 'משפטים' },
  { eng: 'Terumah', heb: 'תרומה' },
  { eng: 'Tetzaveh', heb: 'תצוה' },
  { eng: 'Ki Sisa', heb: 'כי תשא' },
  { eng: 'Vayakhel', heb: 'ויקהל' },
  { eng: 'Pekudei', heb: 'פקודי' },
  { eng: 'Vayikra', heb: 'ויקרא' },
  { eng: 'Tzav', heb: 'צו' },
  { eng: 'Shmini', heb: 'שמיני' },
  { eng: 'Tazria', heb: 'תזריע' },
  { eng: 'Metzora', heb: 'מצורע' },
  { eng: 'Achrei Mos', heb: 'אחרי מות' },
  { eng: 'Kedoshim', heb: 'קדושים' },
  { eng: 'Emor', heb: 'אמור' },
  { eng: 'Behar', heb: 'בהר' },
  { eng: 'Bechukosai', heb: 'בחקותי' },
  { eng: 'Bamidbar', heb: 'במדבר' },
  { eng: 'Nasso', heb: 'נשא' },
  { eng: "Beha'aloscha", heb: 'בהעלתך' },
  { eng: "Sh'lach", heb: 'שלח' },
  { eng: 'Korach', heb: 'קרח' },
  { eng: 'Chukas', heb: 'חקת' },
  { eng: 'Balak', heb: 'בלק' },
  { eng: 'Pinchas', heb: 'פינחס' },
  { eng: 'Matos', heb: 'מטות' },
  { eng: 'Masei', heb: 'מסעי' },
  { eng: 'Devarim', heb: 'דברים' },
  { eng: "Va'eschanan", heb: 'ואתחנן' },
  { eng: 'Eikev', heb: 'עקב' },
  { eng: "Re'eh", heb: 'ראה' },
  { eng: 'Shoftim', heb: 'שופטים' },
  { eng: 'Ki Seitzei', heb: 'כי תצא' },
  { eng: 'Ki Savo', heb: 'כי תבא' },
  { eng: 'Nitzavim', heb: 'נצבים' },
  { eng: 'Vayeilech', heb: 'וילך' },
  { eng: "Ha'Azinu", heb: 'האזינו' },
  { eng: 'Vezos Habracha', heb: 'וזאת הברכה' }
];
Sedra.shabbos_short = [
  52,
  52,
